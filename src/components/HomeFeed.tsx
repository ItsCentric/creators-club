...
function SkeletonFeed() {
  return (
    <div className="mb-2 flex min-h-full w-full max-w-2xl flex-grow flex-col gap-2 divide-y border-x border-gray-300 lg:gap-4 lg:self-center">
      <div className="flex w-full animate-pulse flex-col pt-2">
        <div className="w-fit pb-1">
          <span className="ml-4 mr-1 inline-block h-8 w-8 rounded-full border-2 border-black bg-gray-300 align-middle" />

          <span className="inline-block h-5 w-24 rounded-full bg-gray-300 align-middle" />
        </div>
        <div>
          <div className="bg-gray-100">
            <span className="mx-auto block aspect-square h-96 w-96 bg-gray-300 object-cover" />
          </div>
          <div className="px-4">
            <span className="mt-1 block h-3 max-h-96 rounded-full bg-gray-300" />{" "}
            <span className="mt-1 block h-3 max-h-96 w-4/5 rounded-full bg-gray-300" />
          </div>
        </div>
      </div>
      <div className="flex w-full animate-pulse flex-col pt-2">
